#!/usr/bin/env Rscript
setwd("/Users/ap14958/OneDrive - University of Bristol/Genomics Facility Bioinformatics/Project #12 Swine Flu - Amy Thomas/Counts_no_multi/")
...
volcano_lrt = EnhancedVolcano(res1_lrt,
                ...
                selectLab = rownames(res1_lrt)[res1_lrt$padj <= 0.0005], #label 20 most signifcant ASVs
                drawConnectors = TRUE, 
